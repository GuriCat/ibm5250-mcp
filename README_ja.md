...
- **本配布物は期間限定β公開版です。2026 年 9 月 30 日まで利用できます。**
  2026 年 10 月 1 日以降は、起動および接続が自動的に拒否されます。継続利用には新しい版を入手してください。
- **This is a time-limited release. It works until 2026-09-30.**
  From 2026-10-01, startup and connection are automatically refused. Obtain a newer build to continue.
